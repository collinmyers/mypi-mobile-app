...
export const APPROVED_NON_PROFIT = process.env.EXPO_PUBLIC_APPROVED_NON_PROFIT;

// console.log(API_ENDPOINT, PROJECT_ID, RECOVERY_DOMAIN, DATABASE_ID, MAP_COLLECTION_ID, EVENTS_COLLECTION_ID, ALERTS_COLLECTION_ID, FILE_BUCKET_ID, USER_NOTIFICATION_TOKENS, PUSH_NOTIFICATION_ID, DONATIONS_PROVIDER_LINK, USER_ALIAS_TABLE_ID, FOOD_TRUCK_POI, DELETE_USER_FUNCTION_ID, ABOUT_COLLECTIONS_ID, FAQ_COLLECTIONS_ID, BUNDLER_PACKAGE_IDENTIFIER);
